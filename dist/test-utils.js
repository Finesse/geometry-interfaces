...
export function expectPointsEqual(point1, point2, epsilon = 0, skipJsonCheck = false) {
    ...
    if (!epsilon && !skipJsonCheck)
        expect(point1.toJSON()).toEqual(point2.toJSON());
}
export function expectNumbersEqual(num1, num2, epsilon = 0) {
